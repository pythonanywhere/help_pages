...
Now you just need to reload the web server so that it notices the changes you have made. Visit the Web tab on the PythonAnywhere dashboard and click the "Reload web app" button. That's it. At this stage you have a working admin interface and can visit it at <http://my_username.pythonanywhere.com/admin>.
