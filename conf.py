...
PAGES = (
    ("articles/*.rst", "pages", "story.tmpl"),
    ("articles/*.md", "pages", "story.tmpl"),
    ("articles/*.txt", "pages", "story.tmpl"),
)
...
LOGO_URL = 'https://www.pythonanywhere.com/static/anywhere/images/logo-234x35.png'
